...
filename = 'subjectDataDict.csv'

import os 
mainDir = os.getcwd() 
dataDir = os.path.join(mainDir,'data',filename) 
...
fieldNames = expDict.keys()
dataList = [expDict.keys(),expDict.values()]
dataDict = expDict.values()

with open(dataDir,mode='w') as subData:
    dataWriter = csv.DictWriter(subData,expDict.keys())
    dataWriter.writeheader()
    dataWriter.writerow(expDict) 
